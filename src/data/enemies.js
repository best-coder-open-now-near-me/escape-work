...
export const ENEMY_TYPES = {
  manager: {
    ...
    attacks: [
      { min: 2, max: 4, log: 'The Manager schedules a "quick sync".' },
      { min: 2, max: 4, log: 'The Manager asks for "just one more thing".' },
      { min: 2, max: 4, log: 'The Manager CCs your skip-level.' },
