...
const MODULES = [
  ...
  'src/party-control.js', 'src/sneak-layer.js', 'src/progression-ui.js', 'src/summon-layer.js', 'src/walking.js', 'src/examine.js', 'src/keyboard.js', 'src/mouse.js', 'src/combat-entry.js', 'src/frame.js', 'src/cover-crouch.js', 'src/summon-desk.js', 'src/cover-denial-plans.js',
];
