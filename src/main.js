...
import { createDebugHandles } from './debug-handles.js';
...
function startGame(level) {
  ...
  // The two debug surfaces the outside world sees, built together because they
  // are the same thing at two levels of trust: `__game` answers questions,
  // `__god` hands out the live objects and lets a human edit them. Everything
  // reassignable arrives as a getter - a value captured here is the pre-picker
  // null forever (see debug-handles.js).
  const debugHandles = createDebugHandles({
    get sheet() { return sheet; },
    get player() { return player; },
    get party() { return party; },
    get combat() { return combat; },
    ...
    get playerLayer() { return playerLayer; },
    get climbAnim() { return climbAnim; },
    get legQueue() { return legQueue; },
    get lastPath() { return lastPath; },
    get oocCrouch() { return oocCrouch; },
    get armedOoc() { return armedOoc; },
    get pendingGodPick() { return pendingGodPick; },
    setPendingGodPick: (cb) => { pendingGodPick = cb; },
    get hover() { return hover; },
    get vision() { return vision; },
    get controls() { return controls; },
    get sneakLayer() { return sneakLayer; },
  ...
  window.__game = debugHandles.game;
  window.__god = debugHandles.god;
